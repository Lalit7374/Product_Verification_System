...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch('https://product-verification-system.onrender.com/user/register', {
      method: 'POST',
    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-red-600 to-yellow-400">
      <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-md animate-fadeIn">
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <a href="https://product-verification-system-x6qg.onrender.com/login" className="text-red-600 hover:underline">
            Login here
          </a>
        </p>
      </div>
